...
namespace ADJInsc.Models.Models.DBInsc
{
    public partial class dbActuContext : DbContext
    {
        ...
        public virtual DbSet<DirDupli> DirDupli { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DirDupli>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<Inscriptos>(entity =>
            {
                ...
                entity.Property(e => e.InsFecUltAct)
